...
if(mail($from, $asunto, $mensaje,$headers)){
	header("Location: https://www.revolutionsoft.ml/mpago/checkout_v1_payment_redirect_0a5dbcbb-bec7-4d9e-a63d-269317184802_payment-option-form__source=transfer_spei.html?item_name=$item_name&amount=$amount");
exit();
	}
